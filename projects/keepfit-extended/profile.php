            ...
            <div id="layoutSidenav_content">
                                  ...
                                  <div class="row gutters-sm">
                                    <div class="col-sm-6 mb-3">
                                      <div class="card h-100">
                                        <div class="report-para row py-3 px-3">
                                          <div class="col-sm-6"><h6 class="d-flex align-items-center mb-3"><i class="fas fa-school"></i> &nbsp;&nbsp;Classes</h6></div>
                                          <div class="col-sm-6"><a href="#" class="badge text-white py-2 badge-edit"><i class="fas fa-pen"></i> &nbsp;New Class</a></div>    
                                        </div>
                                        <div class="card-body">
                                    ...
                                    <div class="col-sm-6 mb-3">
                                      <div class="card h-100">
                                        <div class="report-para row py-3 px-3">
                                          <div class="col-sm-6"><h6 class="align-items-center"><i class="fas fa-dumbbell"></i> &nbsp;&nbsp;Challenges</h6></div>
                                          <div class="col-sm-6"><a href="#" class="badge text-white py-2 badge-edit"><i class="fas fa-pen"></i> &nbsp;New Challenge</a></div>    
                                        </div>
                                        <div class="card-body">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade active show" id="home" role="tabpanel">
                        <div class="card-header report-para mt-5"  id="messages">
